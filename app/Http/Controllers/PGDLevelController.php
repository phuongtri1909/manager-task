...
use App\Http\Requests\PGDLevelRequest;
...
class PGDLevelController extends Controller
{
    public string $title = 'Quản lý cấp huyện';
    ...
    {
        $phonggiaodich  = District::active()->get();
        $capxa  = Ward::active()->get();        
        return $this->view('home.index', compact('phonggiaodich','capxa'));
    }
